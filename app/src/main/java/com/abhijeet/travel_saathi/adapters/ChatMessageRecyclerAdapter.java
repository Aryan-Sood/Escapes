...
public class ChatMessageRecyclerAdapter extends FirestoreRecyclerAdapter<ChatroomModel, ChatMessageRecyclerAdapter.ChatroomModelViewHolder> {

    Context context;

    public ChatMessageRecyclerAdapter(@NonNull FirestoreRecyclerOptions<ChatroomModel> options, Context context) {
        super(options);
